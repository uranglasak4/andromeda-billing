                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <span class="avatar avatar-sm"
                                style="background-image: url('https://eu.ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=0D6EFD&color=fff')"></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <a href="#" class="dropdown-item text-danger d-flex align-items-center gap-2"
                    ...
                    <div class="container-fluid">
                        <ul class="navbar-nav">
                            ...
                            @if (auth()->user()->role == 'master')
                                <li class="nav-item {{ Route::is('master.dashboard') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('master.dashboard') }}">
                                        <span class="nav-link-title">Dashboard Master</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Route::is('master.tables') ? 'active' : '' }}">
                                ...
                                <li class="nav-item {{ Route::is('master.pricing') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('master.pricing') }}">
                                        <span class="nav-link-title">Manajemen Harga</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Route::is('master.fnb') ? 'active' : '' }}">
                            ...
                            @elseif(auth()->user()->role == 'admin')
                                ...
                                <li class="nav-item {{ Route::is('admin.orderfnb') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.orderfnb') }}">
                                        <span class="nav-link-title">FnB</span>
                                    </a>
                                </li>
