...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .navbar-brand-title { font-family: 'Orbitron', sans-serif; letter-spacing: 2px; }
    </style>
  </head>
  <body>
                ...
                <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0">
                            <span class="avatar avatar-sm" style="background-image: url(...)">B</span>
                ...
                <div class="navbar navbar-light">
                    <div class="container-fluid">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#">
                                    <span class="nav-link-title">Laporan Pendapatan</span>
                                </a>
                            </li>
                        </ul>
                    </div>
